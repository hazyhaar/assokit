// VanJS 1.5.2 — build IIFE vendored (source officielle : vanjs-core 1.5.2/src/van.js)
// Transformé en IIFE pour exposition comme window.van (compatible script classique).
// Original : export default { tags, hydrate, add, state, derive }
(function (root) {
  "use strict";
  ...
  let runAndCaptureDeps = (f, deps, arg) => {
    ...
    curDeps = deps;
    try { return f(arg); }
    catch (e) { console.error(e); return arg; }
    finally { curDeps = prevDeps; }
  };
  ...
  let stateProto = {
    get val() { curDeps?._getters?.add(this); return this.rawVal; },
    get oldVal() { curDeps?._getters?.add(this); return this._oldVal; },
    set val(v) {
